...
* **Формат даних:** Початкові дані у форматі `.xlsx` було оброблено та зведено в єдину таблицю `.csv`.
* **Обсяг та гранулярність:** Датасет містить 23 810 записів щодо утворення та оброблення відходів в Україні за період з 2015 по 2024 рік, охоплюючи 17 окремих показників.
