...
Аналіз показує, що найбільший % переробки відходів в Тернопільській, Черкаській, Івано-Франківській. Та це зовсім не пов'язане з , а відображає структуру місцевої економіки
Черкащина та Тернопільщина (Агросектор): Основу відходів у цих регіонах складає сільське господарство та харчова промисловість. Більшість таких відходів підприємства одразу пускають у повторний цикл — як добрива, корми або біопаливо для власних котелень.
Івано-Франківщина (Деревообробка): Велику частку займають відходи лісозаготівлі та деревообробки, які масово переробляються на пелети, плити ДСП/ДВП чи спалюються для генерації тепла.
Тож, високий відсоток переробки у цих областях відображає високий рівень промислового рециклінгу, а не високий рівень сортування побутового сміття серед населення.
